...
#if !defined(horizondeps_httpclient_response_get_header_value_by_index_ctxt_implementation)
#define horizondeps_httpclient_response_get_header_value_by_index_ctxt_implementation
