...
#if !defined(horizondeps_httpclient_response_get_header_size_ctxt_implementation)
#define horizondeps_httpclient_response_get_header_size_ctxt_implementation
