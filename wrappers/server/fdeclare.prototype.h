#if !defined(PROJECT_NAMEdeps_server_request_typedef)
#define PROJECT_NAMEdeps_server_request_typedef
typedef struct PROJECT_NAMEdeps_server_request PROJECT_NAMEdeps_server_request;
#endif

#if !defined(PROJECT_NAMEdeps_server_response_typedef)
#define PROJECT_NAMEdeps_server_response_typedef
typedef struct PROJECT_NAMEdeps_server_response PROJECT_NAMEdeps_server_response;
#endif

#if !defined(PROJECT_NAMEdeps_server_globals_prototype)
#define PROJECT_NAMEdeps_server_globals_prototype
extern PROJECT_NAMEdeps_server_response *(*PROJECT_NAMEdeps_server_global_handler)(PROJECT_NAMEdeps_server_request *, void *);
...
const char *PROJECT_NAMEdeps_server_get_route_ctxt(void *ctxt, PROJECT_NAMEdeps_server_request *request);
#endif
...
const char *PROJECT_NAMEdeps_server_get_header_key_ctxt(void *ctxt, PROJECT_NAMEdeps_server_request *request, int index);
#endif
...
const char *PROJECT_NAMEdeps_server_get_header_value_ctxt(void *ctxt, PROJECT_NAMEdeps_server_request *request, int index);
#endif
...
int PROJECT_NAMEdeps_server_get_query_param_count_ctxt(void *ctxt, PROJECT_NAMEdeps_server_request *request);
#endif
